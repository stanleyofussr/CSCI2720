...
class Project extends React.Component {
	constructor(props) {
		super(props);
		this.state = { username: null, admin: false, page: "stops", showDetail: false, detailToShow: "" };
	...
	clickStops = (e) => {
		this.setState({ page: "stops", showDetail: false });
	}
	clickFavorUser = (e) => {
		if (this.state.username != null) {
			this.setState({ page: "favourite", showDetail: false });
		} else {
			this.setState({ page: "users", showDetail: false });
		}
	}

	showDetail = (stopid, event) => {
		this.setState({
			detailToShow: stopid,
			showDetail: true
